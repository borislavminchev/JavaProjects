...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\bmintchev\\IdeaProjects\\Music\\" + DB_NAME;
    ...
    public static final String QUERY_ALBUMS_BY_ARTISTS_ID = "SELECT * FROM " + TABLE_ALBUMS +
    ...
    public boolean open() {
        try {
            ...
            queryAlbumsByArtistId = conn.prepareStatement(QUERY_ALBUMS_BY_ARTISTS_ID);
